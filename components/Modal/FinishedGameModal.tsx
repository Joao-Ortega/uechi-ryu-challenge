          ...
          >
            ...
            <Box display='flex'>
              <Typography
                fontSize={22}
                sx={{
                  color: points === (mode === 'DAN' || mode === 'Exam' ? 1 : 5) ? 'black' : points < (mode === 'DAN' || mode === 'Exam' ? 1 : 5) ? 'red' : 'green',
              ...
              <Typography fontSize={22} sx={{ fontWeight: 900 }}>{mode === 'DAN' || mode === 'Exam' ? '/2'  : '/10'}</Typography>
            </Box>
            <Button
              variant='contained'
              size='small'
