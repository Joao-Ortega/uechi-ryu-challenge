...
export const challenges: IQuestions[] = [
  ...
  },
  {
    ...
    options: [
      { correct: 0, data: 'Técnicas de socos' },
...
export const adultsWhiteYellow: IQuestions[] = [
  ...challenges,
  {
    type: 'text',
    content: 'Quais são os 3 Katas "principais" que vieram com Kanbun Uechi após seus anos de estudo na China?',
...
export const adultsOrangeDarkBlue: IQuestions[] = [
  ...adultsWhiteYellow,
  {
    type: 'image',
    content: [kiba, 'Qual o nome da base acima?'],
...
export const teensAdultsTest: IQuestions[] = [
  {
    type: 'text',
    content: 'Qual o significado da palavra Karate Do?',
    options: [
...
export const danTest: IQuestions[] = [
  {
    type: 'text',
    content: 'Qual nome original do estilo, país de origem e significado?',
    options: [
  ...
  {
    type: 'text',
    content: 'Quais os três Katas que vieram originariamente da China?',
    options: [
      { correct: 1, data: 'Sanchin - Seichin - Seiryu' },
      { correct: 2, data: 'Kanchin - Kanshu - Seisan' },
      { correct: 0, data: 'Sanchin - Seisan - Sanseiryu' },
  ...
  {
    type: 'text',
    content: 'Qual a data de nascimento de Kanbun Uechi?',
    options: [
      { correct: 3, data: '10 de agosto de 1873.' },
      { correct: 0, data: '5 de maio de 1877.' },
      { correct: 1, data: '23 de novembro de 1910.' },
      { correct: 2, data: '7 de abril de 1918.' },
    ]
  },
  {
    type: 'text',
    content: 'Em que região de Okinawa, nasceu Kanbun Uechi',
    options: [
      { correct: 3, data: 'Uruma, distrito de Nakagami' },
      { correct: 2, data: 'Itoman, distrito de Shimajiri' },
      { correct: 1, data: 'Nago, distrito de Nago' },
      { correct: 0, data: 'Motobu, distrito de Kunigami' },
    ]
  },
  {
    type: 'text',
    content: 'Qual a data da morte de Kanbun Uechi',
    options: [
      { correct: 3, data: '12 de outubro de 1933.' },
      { correct: 1, data: '7 de julho de 1955.' },
      { correct: 0, data: '25 de novembro de 1948.' },
      { correct: 2, data: '3 de maio de 1927.' },
    ]
  },
  {
    type: 'text',
    content: 'Com quantos anos Kanbun Uechi foi para China?',
    options: [
      { correct: 2, data: '21 anos.' },
      { correct: 0, data: '20 anos.' },
      { correct: 1, data: '23 anos.' },
      { correct: 3, data: '18 anos.' },
    ]
  },
  {
    type: 'text',
    content: 'Oque significa OKIKUKAI?',
    options: [
      { correct: 0, data: 'Okinawa Karatedo Kyokai (Associação de Karate de Okinawa).' },
      { correct: 3, data: 'Ryukyu Karatedo Kyokai (Associação de Karate de Okinawa).' },
      { correct: 2, data: 'Okinawa Kenpo Kyokai (Associação de Karate de Okinawa).' },
      { correct: 1, data: 'Okinawa Karatedo Renmei (Associação de Karate de Okinawa).' },
    ]
  },
]
